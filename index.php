          ...
          <form class="row g-3" id="formRedo" method="post">
            ...
            <div class="col-md-6">
              <div class="input-group date md-6" data-provide="datepicker" id="salida">
                ...
                <div class="form-floating">
                  <input class="form-control fechaSalida" id="salida1" data-date-format="mm/dd/yyyy">
            ...
            <div class="col-md-6">
              <div class="input-group date md-6" data-provide="datepicker" id="regreso">
                <button class="btn btn-light" type="button" id="selectFecha"><i class="bi bi-calendar-event"></i></button>
                <div class="form-floating">
                  <input class="form-control fechaRegreso" id="regreso1" data-date-format="mm/dd/yyyy">
            ...
            <div class="col-md-6">
              ...
              <select id="inputPasajeros" class="form-select">
                ...
                <?php
                  for ($i = 1; $i <= 12; $i++) {                    
                    echo '<option value="'.$i.'">'.$i.' pasajeros</option>';
                  }
                ?>
              </select>
            </div>
            ...
            <div class="col-md-12">
              ...
              <button type="button" class="btn btn-primary" name="ofertas"><img src="https://cdn-icons-png.flaticon.com/512/68/68380.png" height="20px"> Buscar vuelo</button>
                <a href="https://www.yavas.com/?utm_source=volaris_icon_yavas1&utm_medium=referral&utm_campaign=es&adfcd=1679363443.OajPAUfx30SquAvynPn0Vw.MjYzMjYxNSwxODY5NzQz" class="btn btn-primary"> <img src="https://cdn-icons-png.flaticon.com/512/1475/1475996.png" name="hotel" height="20px"> Buscar vuelo + hotel</a>
              </div>
            </div>
          </form>          
        </div>
          ...
          <form class="row g-3" id="formSen" method="post">
            ...
            <div class="col-md-6">
              <div class="input-group date md-6" data-provide="datepicker" id="salida">
                <button class="btn btn-light" type="button" id="selectFecha"><i class="bi bi-calendar-event"></i></button>
                <div class="form-floating">
                  <input class="form-control fechaSalida" id="salida2" data-date-format="mm/dd/yyyy">
                  <label for="fechaSalida">Selecciona la fecha de salida</label>
                </div>
              </div>
            </div>
            ...
            <div id="membresias-tipos" class="owl-carousel">
              <div class="item">
                <div class="card border-primary">
                  <img src="img/vClub.jpg" class="card-img-top" height="178px" alt="v.club">
                  <div class="card-body">
                    <h3 class="card-title">
              ...
              <div class="item">
                <div class="card border-primary">
                  <img src="img/invex.jpg" class="card-img-top" alt="invex">
                  <div class="card-body">
                    <h3 class="card-title">
              ...
              <div class="item">
                <div class="card border-primary">
                  <img src="img/vBusiness.jpg" class="card-img-top" alt="v.business">
                  <div class="card-body">
                    <h3 class="card-title">
              ...
              <div class="item">
                <div class="card border-primary">
                  <img src="img/vPass.jpeg" class="card-img-top" alt="v.pass">
                  <div class="card-body">
                    <h3 class="card-title">
