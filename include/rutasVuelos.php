...
function formVuelos($tipoVuelo, $obligar)
{
  $salida = "";
  ...
  $salida .= "  <select id=\"origenVuelo" . $tipoVuelo . "\" name=\"origenVuelo" . $tipoVuelo . "\" class=\"form-select form-select-md\">";
  ...
  $salida .= "  <select id=\"destinoVuelo" . $tipoVuelo . "\" name=\"destinoVuelo" . $tipoVuelo . "\" class=\"form-select form-select-md\" " . $obligar . ">";
  $salida .= "    <option selected disabled value='0' selected>Selecciona el lugar de destino</option>";
